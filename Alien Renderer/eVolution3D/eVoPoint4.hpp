...
struct eVoPoint4
{
	...
	public: eVoPoint4(float ax, float ay, float az)
	{
		x = ax;
		y = ay;
		z = az;
	...
	public: eVoPoint4 operator=(eVoPoint4& point)
	{
		x = point.x;
		y = point.y;
		z = point.z;
	...
	public: eVoVector4 operator-(eVoPoint4& point)
	{
	...
	public: bool operator==(eVoPoint4& point)
	{
